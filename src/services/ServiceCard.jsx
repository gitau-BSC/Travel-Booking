...
const ServiceCard = ({icon:Icon, title, desc}) => {
  return (
    <div className='w-full bg-neutral-300 hover:bg-transparent rounded-xl p-7 flex items-center justify-center gap-4 flex-col text-center cursor-pointer ease-in-out duration-300'>
